...
uint8_t KERNEL_CALL ata_read_sectors(ata_device_t* dv,uint64_t lba,uint16_t c){
	...
	asm_port_out8(ATA_DRIVER_CONTROL_REGISTER(dv->ch),ATA_DRIVER_CONTROL_ENABLE_HIGH_CALLTIONS|ATA_DRIVER_CONTROL_OBSOLETE|ATA_DRIVER_CONTROL_DISABLE_INTERRUPTS);
